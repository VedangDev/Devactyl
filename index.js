...
const listener = app.listen(settings.website.port, function() {
  console.log(Chalk.green(`[Purple] Settings Loading...`))
console.log(Chalk.green(`[Purple] Settings Loaded...`))
console.log(Chalk.green(`[Purple] Database Loading...`))
console.log(Chalk.green(`[Purple] Database Loaded...`))
console.log(Chalk.green(`[Purple] Pages Loading...`))
console.log(Chalk.green(`[Purple] Pages Loaded...`))
console.log(Chalk.green(`[Purple] Trying To Run Purple On Domain...`))
console.log(chalk.green("[Purple] Finishing & deploying faliactyl..."));
console.log(chalk.green("----------------------------------------------------"));
console.log(chalk.green("Purple: v1"));
console.log(chalk.green(`Release: v0.1`));
console.log(chalk.green("----------------------------------------------------"));
console.log(chalk.green(`Your dashboard will now be available on port` + listener.address().port + "."));
console.log(chalk.green("----------------------------------------------------"));
console.log(chalk.rgb(164, 56, 234))(
